...
Если старый PR был закрыт, можно безопасно открывать новый PR с тем же набором изменений — это не требует изменения структуры данных и не ломает существующие аккаунты/токены.
